...
class PrefacturaFijaController extends Controller
{
    ...
    public function actionCreate(){
        ...
        if ($model->load(Yii::$app->request->post())) {
            ...
            $empresa_guardar=$empresasUsuario->nit;
    ...
    public function actionImprimir($id){
        ...
        $logo=Empresa::find()->where('nit="'.$nit.'"')->one();
        date_default_timezone_set ( 'America/Bogota');
        $dispositivos = PrefacturaDispositivo::find()->where('id_prefactura_fija='.$id)->all();
    ...
    public function actionEnviar_aprobacion_gerente($id){
        $model = $this->findModel($id);
        $model->setAttribute('estado_pedido','G');
        $model->save();
        return $this->redirect(['index']);
    }
}