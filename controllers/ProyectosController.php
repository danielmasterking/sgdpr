...
class ProyectosController extends Controller{
    ...
    public function actionIndex(){
        ...
        ->select('pr.id id, '.
            ...
            "(SELECT COUNT(pp.id) FROM proyecto_pedidos pp WHERE pr.id=pp.proyecto_id AND pp.gasto_activo='activo') count_normal_activo,".
            "(SELECT COUNT(pp.id) FROM proyecto_pedidos pp WHERE pr.id=pp.proyecto_id AND pp.gasto_activo='gasto') count_normal_gasto,".
            ...
            "(SELECT COUNT(pp.id) FROM proyecto_pedido_especial pp WHERE pr.id=pp.proyecto_id AND pp.gasto_activo='activo') count_especial_activo,".
            "(SELECT COUNT(pp.id) FROM proyecto_pedido_especial pp WHERE pr.id=pp.proyecto_id AND pp.gasto_activo='gasto') count_especial_gasto,".
    ...
    public function actionUpdate($id,$actualizar=0){
       $model = $this->findModel($id);
