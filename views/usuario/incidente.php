             ...
             <?php foreach($incidentes_usuario as $key):?>	  
              ...
              <tr>			   
			   <td><?php
                ...
                if($key->fecha > '2018-01-01'){

               ?>
               <a href="<?= Yii::$app->request->baseUrl.'/incidente/imprimir?id='.$key->id?>" target='_blank' class='btn btn-info btn-sm'>
               	<i class="fa fa-eye"></i>
               </a>
               <?php
                }else{
                	echo Html::a('<i class="fa fa-eye"></i>',Yii::$app->request->baseUrl.'/incidente/view-from-cordinador?id='.$key->id,['class'=>'btn btn-info btn-sm']);
            	}
            	if(in_array("administrador", $permisos) ){
                  ...
                  echo Html::a('<i class="fa fa-trash"></i>',Yii::$app->request->baseUrl.'/incidente/delete-from-cordinador?id='.$key->id.'&usuario='.$key->usuario,['data-method'=>'post', 'data-confirm' => 'Está seguro de eliminar elemento','class'=>'btn btn-danger btn-sm']);
