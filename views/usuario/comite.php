             ...
             <?php foreach($comites_usuario as $comite):?>	  
              ...
              <tr>			   
			   <td><?php
                ...
                echo Html::a('<i class="fa fa-eye"></i>',Yii::$app->request->baseUrl.'/comite/view-from-cordinador?id='.$comite->id,['class'=>'btn btn-info btn-sm']);
               if(in_array("administrador", $permisos) ){
				 ...
				 // echo Html::a('<i class="fa fa-pencil fa-fw"></i>',Yii::$app->request->baseUrl.'/capacitacion/update?id='.$capacitacion->capacitacion_id);
                  echo Html::a('<i class="fa fa-trash"></i>',Yii::$app->request->baseUrl.'/comite/delete-from-cordinador?id='.$comite->id.'&usuario='.$comite->usuario,['data-method'=>'post','data-confirm' => 'Está seguro de eliminar elemento','class'=>'btn btn-danger btn-sm']);
