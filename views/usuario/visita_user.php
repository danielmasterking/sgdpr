...
<br>
<?= $this->render('_tabs_visita',['visita' => 'active','usuario' => $usuario]) ?>
<br>
             ...
             <?php foreach($visitas_usuario as $visita):?>	  
              ...
              <tr>			   
			   <td><?php
                ...
                echo Html::a('<i class="fa fa-eye"></i>',Yii::$app->request->baseUrl.'/visita-dia/view?id='.$visita->id.'&dependencia='.$visita->centro_costo_codigo,['class'=>'btn btn-info btn-sm']);
            	if( in_array("administrador", $permisos) ){
                  ...
                  echo Html::a('<i class="fa fa-trash"></i>',Yii::$app->request->baseUrl.'/visita-dia/delete-from-cordinador?id='.$visita->id.'&usuario='.$visita->usuario,['data-method'=>'post', 'data-confirm' => 'Está seguro de eliminar elemento','class'=>'btn btn-danger btn-sm']);
