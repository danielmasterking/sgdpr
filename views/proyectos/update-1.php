...
function validar(){
    ...
    presupuesto_seguridad=parseInt(($("#presupuesto_seguridad").val()).replaceAll(".", ""));
    presupuesto_riesgo=parseInt(($("#presupuesto_riesgo").val()).replaceAll(".", ""));
    /*presupuesto_activo=parseInt(($("#presupuesto_activo").val()).replaceAll(".", ""));
    presupuesto_gasto=parseInt(($("#presupuesto_gasto").val()).replaceAll(".", ""));*/
    if(presupuesto_seguridad<1 && presupuesto_riesgo<1){
