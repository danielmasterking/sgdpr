  ...
  <table class="display my-data" data-page-length='50' cellspacing="0" width="100%">
   ...
   <tbody>
     ...
     <tr>
      ...
      echo Html::a('<i class="fa fa-trash"></i>',Yii::$app->request->baseUrl.'/distrito/delete-dependencia?id='.$key->distrito_id.'&codigo='.$key->centro_costo_codigo,['class'=>'btn btn-danger btn-xs']);
