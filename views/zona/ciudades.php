   ...
   <?php foreach($ciudades_asignadas as $key):?>
      ...
      <tr>
        ...
        <td><?php
            ...
            echo Html::a('<i class="fa fa-trash"></i>',Yii::$app->request->baseUrl.'/zona/delete-ciudad?id='.$key->zona_id.'&codigo_dane='.$key->ciudad_codigo_dane,['class'=>'btn btn-danger btn-xs','data-confirm'=>'Seguro desea quitar?']);
