                            ...
                            <div class="chat-body clearfix">
                                <div class="header">
                                    <strong class="primary-font"><?= $not->titulo ?></strong> <small class="pull-right text-muted">
                                        ...
                                        <input type="checkbox" title="Marcar como leido" onclick="leido(<?= $not->id?>,'<?=Yii::$app->session['usuario-exito']?>');">
                                </div>
                                <p>
                                    <i class="fas fa-info-circle text-red"></i> Notificacion de informacion del sistema.
                                </p>
                            </div>
                        </li>
                        </a>
