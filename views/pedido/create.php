...
<div class="page-header">
    <h1><small><i class="fa fa-shopping-cart fa-fw"></i></small> <?= Html::encode($this->title) ?></h1>
  </div>
<div id="info"></div>
<?php if (!isset($especial)): ?>
...
var productos= [];
  ...
  //console.log(len_productos);
function buscarPedidos_normales(page,codigo_dependencia){
  ...
  $.ajax({
    ...
    if(contador==2){
        ...
        buscarPedidos_normales(contador,codigo_dependencia);
          contador++;
