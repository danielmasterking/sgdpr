...
<script>
	...
	$("#modeloprefactura-horas").on('change',function(){
	   ...
	   ftes_diurno=(((tiempo_diurna.hours()+(tiempo_diurna.minutes()/60))*dias_prestados*cantidad)/240)*parseInt($('#modeloprefactura-porcentaje').val())/100;

	   //ftes_nocturno=(((tiempo_nocturno.hours()+(tiempo_nocturno.minutes()/60))*dias_prestados*cantidad)/240);

	   ftes_nocturno=(((tiempo_nocturno.hours()+(tiempo_nocturno.minutes()/60))*dias_prestados*cantidad)/240)*parseInt($('#modeloprefactura-porcentaje').val())/100;
